...
sonarqube_db = dockerCompose.ComposeService('sonarqube_db', 'postgres:latest')
sonarqube_db.set_restart('unless-stopped')
sonarqube_db.set_container_name('sonarqube_db')
sonarqube_db.add_environment('POSTGRES_USER', 'admin')
sonarqube_db.add_environment('POSTGRES_PASSWORD', 'Admin123')
sonarqube_db.add_environment('POSTGRES_DB', 'sonarqube')
...
compose.add_service(sonarqube_db)
